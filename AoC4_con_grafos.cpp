...
int contador_acesibles(grafo &g, int contador, vector<string> &rejilla){ // la paso por referencia para que no haga un copia de todo el grafo y la pongo como constante para estar segura de que nada me modifique el grafo
    for(int x = 0; x<g.nodos.size(); x++){
...
int main(){
    ...
    definitivo = contador_acesibles(AoC, count, rejilla);
